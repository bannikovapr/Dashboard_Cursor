...
8. Словарь: СННО = MTBF (наработка на отказ), СВВ = MTTR (время восстановления), КТГ = коэффициент технической готовности. Ремонты сотрудников = работы сотрудников = загрузка персонала = трудозатраты сотрудников (годовой срез fact_h/plan_h).
