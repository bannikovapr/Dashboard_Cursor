...
function buildSystemPrompt() {
  return [
    ...
    "Словарь для сопоставления (используй молча, не цитируй имена полей пользователю): СННО — наработка на отказ, часы по объектам в разделе показателей MTBF; СВР — время восстановления (MTTR); КТГ — готовность по объектам в таблице КТГ.",
